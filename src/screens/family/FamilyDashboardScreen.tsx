...
export default function FamilyDashboardScreen() {
  ...
  const { children, pendingApprovals, fetchChildren, fetchPendingApprovals, isLoading } = useFamilyStore();
      ...
      <ScrollView
        ...
        refreshControl={
          <RefreshControl
            ...
            onRefresh={() => { fetchChildren(); fetchPendingApprovals(); }}
            ...
            <TouchableOpacity
              ...
              <View className="flex-row items-center gap-3">
                ...
                <View className="h-6 min-w-6 items-center justify-center rounded-full bg-amber-500 px-1.5">
                  <Text className="text-[11px] font-black text-white">{pendingApprovals.length}</Text>
                </View>
              </View>
            </TouchableOpacity>
          </Animated.View>
