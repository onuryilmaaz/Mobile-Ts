...
export default function HomeScreen({ navigation }: Props) {
  ...
  return (
    <Screen style={{ backgroundColor: colors.bg }} safeAreaEdges={['left', 'right']}>
      <ScrollView
        style={{ flex: 1 }}
        refreshControl={
          <RefreshControl
            ...
            <ScrollView
              ...
              {QUICK_ACTIONS.map((action) => (
                <TouchableOpacity
                  ...
                  <View style={{
                    height: 52, width: 52, borderRadius: 18,
                    backgroundColor: isDark ? `${action.color}20` : `${action.color}15`,
                    borderWidth: 1, borderColor: `${action.color}35`,
                    alignItems: 'center', justifyContent: 'center',
                    marginBottom: 12,
                    shadowColor: action.color,
                    shadowOpacity: isDark ? 0.5 : 0.15, shadowRadius: 8,
                  }}>
